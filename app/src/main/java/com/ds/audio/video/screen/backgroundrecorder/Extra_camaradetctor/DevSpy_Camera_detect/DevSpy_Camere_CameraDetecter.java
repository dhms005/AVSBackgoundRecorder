...
public class DevSpy_Camere_CameraDetecter extends AppCompatActivity implements SensorEventListener, OnChartValueSelectedListener {
    int[] beep = {R.raw.beep};
    private Gauge gauge;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.devspy_camere_activity_camera_detecter);
