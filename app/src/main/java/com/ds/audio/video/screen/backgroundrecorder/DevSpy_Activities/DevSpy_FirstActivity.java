...
import com.ds.audio.video.screen.backgroundrecorder.ads.DevSpy_Custom_Full_Ad_Timer;
...
import com.ds.audio.video.screen.backgroundrecorder.exit.DevSpy_RecomendedAppsDailogAdapter_New;
import com.ds.audio.video.screen.backgroundrecorder.exit.DevSpy_RecomendedAppsDialog;
import com.ds.audio.video.screen.backgroundrecorder.exit.DevSpy_RecommandDatabaseModel;
 ...
 */
public class DevSpy_FirstActivity extends FCMActivity implements PurchasesUpdatedListener {
    ...
    private DevSpy_RecomendedAppsDailogAdapter_New mTreadingAppAdapter;
    private DevSpy_RecomendedAppsDailogAdapter_New mRecomendedAppsDailogAdapterNew;
    ...
    DevSpy_Custom_Full_Ad_Timer ESCustom_full_ad_timer;
    DevSpy_Custom_AppLovin_Timer custom_appLovin_timer;
    int _showAdTimer;
    Handler handler;
    Runnable runnable;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.devspy_first_activity);
...
//        }
        ...
        img_qureka1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Utility.OpenCustomQurekaBrowser(DevSpy_FirstActivity.this);
            }
        });
...
//                    }
                    ...
                    Toast.makeText(DevSpy_FirstActivity.this, "Error code->  " + billingResult.getResponseCode(), Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void mClickListener() {
        btnStart_F.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Permission_check(DevSpy_FirstActivity.this)) {
                    DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_FirstActivity.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                        ...
                        public void callbackCall() {
                            if (SharePrefUtils.getString(Constant_ad.AD_MULTIPLE_START, "1").equals("1")) {
                                Intent i = new Intent(DevSpy_FirstActivity.this, DevSpy_Second_StartScreen.class);
                                startActivity(i);
                            } else {
                                Intent i = new Intent(DevSpy_FirstActivity.this, DevSpy_ActivityHomeMenu.class);
                                startActivity(i);
                            }
                        }
                    });
        ...
        mTextPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mFirebaseAnalytics.logEvent("FirstActivity", params);
                if (!DevSpy_Utility.isConnectivityAvailable(DevSpy_FirstActivity.this)) {
                    Toast.makeText(DevSpy_FirstActivity.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(DevSpy_FirstActivity.this, DevSpy_PrivacyPolicyActivity.class);
                    startActivity(in);
                }
            }
        });
...
//        btnStart_F = (MaterialButton) findViewById(R.id.img_start);
    ...
    private void setData(JSONObject response) {
        try {
            ...
            ArrayList<DevSpy_RecommandDatabaseModel> typeThreeArrayList = new ArrayList<DevSpy_RecommandDatabaseModel>();
            ...
            if (typeOneArrayList.isEmpty()) {
                ...
                mRecomendedAppsDailogAdapterNew = new DevSpy_RecomendedAppsDailogAdapter_New(DevSpy_FirstActivity.this, typeOneArrayList, 8, "1");
            ...
            if (typeThreeArrayList.isEmpty()) {
                ...
                text_title_treading_app.setVisibility(View.GONE);
                mCardViewTreadingApp.setVisibility(View.GONE);
                mTreadingAppAdapter = new DevSpy_RecomendedAppsDailogAdapter_New(DevSpy_FirstActivity.this, typeThreeArrayList, 9, "2");
    ...
    private void getDataService() {
        if (DevSpy_Utility.isConnectivityAvailable(DevSpy_FirstActivity.this)) {
            ...
            RequestQueue mRequestQueue = Volley.newRequestQueue(DevSpy_FirstActivity.this);
...
//                }
    ...
    public void onBackPressed() {
        DevSpy_Admob_Full_AD_New.getInstance().showInterBack(this, new DevSpy_Admob_Full_AD_New.MyCallback() {
            @Override
            public void callbackCall() {
                Intent intent = new Intent(DevSpy_FirstActivity.this, DevSpy_RecomendedAppsDialog.class);
                ...
                protected Void doInBackground(Void... voids) {
                    FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(new OnSuccessListener<InstanceIdResult>() {
                        ...
                        public void onSuccess(InstanceIdResult instanceIdResult) {
                            ...
                            final SharedPreferences prefs = DevSpy_FirstActivity.this.getSharedPreferences("GCM",
                            ...
                            if (token == null) {
                                Server.updateToken(DevSpy_FirstActivity.this, "1234");
                                ...
                                editor.commit();
                                Server.updateToken(DevSpy_FirstActivity.this, token);
            ...
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                try {
                    mAppUpdateManager.startUpdateFlowForResult(
                            appUpdateInfo, AppUpdateType.FLEXIBLE, DevSpy_FirstActivity.this, RC_APP_UPDATE);
                ...
                try {
                    mAppUpdateManager.startUpdateFlowForResult(
                            appUpdateInfo, IMMEDIATE, DevSpy_FirstActivity.this, RC_APP_UPDATE);
                } catch (IntentSender.SendIntentException e) {
                    e.printStackTrace();
                }
...
//                        Log.e("error", "InstallStateUpdatedListener: state: " + state.installStatus());
                ...
                .addOnSuccessListener(
                        appUpdateInfo -> {
                            if (appUpdateInfo.updateAvailability()
                                ...
                                try {
                                    mAppUpdateManager.startUpdateFlowForResult(
                                            appUpdateInfo, AppUpdateType.IMMEDIATE, DevSpy_FirstActivity.this, RC_APP_UPDATE);
                                } catch (IntentSender.SendIntentException e) {
                                    e.printStackTrace();
                                }
                            }
                ...
                public void run() {
                    ...
                    if (resume_check.equals("1")) {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                DevSpy_Utility.isTimerAdShow = true;
    ...
    public void load_full_ad() {
        ...
        ESCustom_full_ad_timer.setMyNativeAdListener(new DevSpy_Custom_Full_Ad_Timer.MyAdViewAdListener() {
            @Override
    ...
    public void load_app_Lovin_full_ad() {
        ...
        custom_appLovin_timer.setMyNativeAdListener(new DevSpy_Custom_AppLovin_Timer.MyAdViewAdListener() {
            @Override
            public void onAdClosed() {
                handler.postDelayed(runnable, _showAdTimer);
            }
...
//                Log.e("#DEBUG", "First ad onAdOpened");
    ...
    private void installAppDialog(String path) {
        ...
        downloadDialog = new Dialog(DevSpy_FirstActivity.this);
        downloadDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        downloadDialog.setCancelable(false);
        downloadDialog.setContentView(R.layout.devspy_dialog_installapp);
...
//                Toast.makeText(this, "Permission granted", Toast.LENGTH_SHORT).show();
    ...
    public void VPNDialog() {
        downloadDialogVPN = new Dialog(DevSpy_FirstActivity.this);
        downloadDialogVPN.requestWindowFeature(Window.FEATURE_NO_TITLE);
        downloadDialogVPN.setCancelable(false);
        downloadDialogVPN.setContentView(R.layout.devspy_dialog_vpn_connection);
