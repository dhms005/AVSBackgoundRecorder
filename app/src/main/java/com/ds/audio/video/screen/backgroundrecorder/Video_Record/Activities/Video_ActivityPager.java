...
import com.ds.audio.video.screen.backgroundrecorder.Video_Record.Adapter.VideoViewPagerAdapter;
...
public class Video_ActivityPager extends AppCompatActivity {
    TabLayout tabLayout;
  ViewPager viewPager;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.video_activity_pager);
        defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(Video_ActivityPager.this);
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(Video_ActivityPager.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        ...
                        Intent intent = new Intent(Video_ActivityPager.this, Video_Setting_Activity.class);
    ...
    private void setupViewPager(ViewPager viewPager2) {
        VideoViewPagerAdapter cCTVViewPagerAdapter = new VideoViewPagerAdapter(getSupportFragmentManager());
        cCTVViewPagerAdapter.addFrag(new Video_RecorderFragment(), "Recorder");
