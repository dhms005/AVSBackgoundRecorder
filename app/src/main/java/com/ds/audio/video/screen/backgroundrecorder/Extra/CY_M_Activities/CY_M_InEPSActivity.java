...
public class CY_M_InEPSActivity extends AppCompatActivity {
    DecoView arcView;
    int check = 0;
    TextView completion;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_in_eps);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_InEPSActivity.this);
            }
        });
//        mNativeAdNew();
        ...
        build.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            ...
            public void onSeriesItemAnimationProgress(float f, float f2) {
                ...
                TextView textView = CY_M_InEPSActivity.this.completion;
                textView.setText(intValue + "%");
                if (f2 >= 10.0f && f2 < 40.0f) {
                    CY_M_InEPSActivity.this.ist.setTextColor(Color.parseColor("#136af6"));
                    CY_M_InEPSActivity.this.istpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 40.0f && f2 < 65.0f) {
                    CY_M_InEPSActivity.this.sec.setTextColor(Color.parseColor("#136af6"));
                    CY_M_InEPSActivity.this.secpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 65.0f && f2 < 80.0f) {
                    CY_M_InEPSActivity.this.thir.setTextColor(Color.parseColor("#136af6"));
                    CY_M_InEPSActivity.this.thirpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 80.0f && f2 < 90.0f) {
                    CY_M_InEPSActivity.this.fou.setTextColor(Color.parseColor("#136af6"));
                    CY_M_InEPSActivity.this.foupic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 90.0f && f2 < 100.0f) {
                    CY_M_InEPSActivity.this.fif.setTextColor(Color.parseColor("#136af6"));
                    CY_M_InEPSActivity.this.fifthpic.setImageResource(R.drawable.ic_brown_dot);
                }
            }
        });
        ...
        this.arcView.addEvent(new DecoEvent.Builder(100.0f).setIndex(addSeries).setDelay(1000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventEnd(DecoEvent decoEvent) {
                CY_M_InEPSActivity.this.check = 1;
                CY_M_InEPSActivity CYMInEPSActivity = CY_M_InEPSActivity.this;
                CYMInEPSActivity.youDesirePermissionCode(CYMInEPSActivity);
                CY_M_InEPSActivity.this.enablesall();
            }
        }).build());
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_InEPSActivity.this.onBackPressed();
            }
        });
    }
