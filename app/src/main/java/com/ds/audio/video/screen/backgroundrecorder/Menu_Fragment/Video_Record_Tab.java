...
public class Video_Record_Tab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.video_record_tab, container, false);
        context = getContext();
            ...
            public void onClick(View v) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(getActivity(), new CY_M_Admob_Full_AD_New.MyCallback() {
                    ...
                    public void callbackCall() {
                        ...
                        Intent intent = new Intent(getActivity(), Video_Setting_Activity.class);
                        startActivity(intent);
                    }
                });
            }
