...
public class DevSpy_InEPSActivity extends AppCompatActivity {
    DecoView arcView;
    int check = 0;
    TextView completion;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.devspy_activity_in_eps);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Utility.OpenCustomQurekaBrowser(DevSpy_InEPSActivity.this);
            }
        });
//        mNativeAdNew();
        ...
        build.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            ...
            public void onSeriesItemAnimationProgress(float f, float f2) {
                ...
                TextView textView = DevSpy_InEPSActivity.this.completion;
                textView.setText(intValue + "%");
                if (f2 >= 10.0f && f2 < 40.0f) {
                    DevSpy_InEPSActivity.this.ist.setTextColor(Color.parseColor("#136af6"));
                    DevSpy_InEPSActivity.this.istpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 40.0f && f2 < 65.0f) {
                    DevSpy_InEPSActivity.this.sec.setTextColor(Color.parseColor("#136af6"));
                    DevSpy_InEPSActivity.this.secpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 65.0f && f2 < 80.0f) {
                    DevSpy_InEPSActivity.this.thir.setTextColor(Color.parseColor("#136af6"));
                    DevSpy_InEPSActivity.this.thirpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 80.0f && f2 < 90.0f) {
                    DevSpy_InEPSActivity.this.fou.setTextColor(Color.parseColor("#136af6"));
                    DevSpy_InEPSActivity.this.foupic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 90.0f && f2 < 100.0f) {
                    DevSpy_InEPSActivity.this.fif.setTextColor(Color.parseColor("#136af6"));
                    DevSpy_InEPSActivity.this.fifthpic.setImageResource(R.drawable.ic_brown_dot);
                }
            }
        });
        ...
        this.arcView.addEvent(new DecoEvent.Builder(100.0f).setIndex(addSeries).setDelay(1000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventEnd(DecoEvent decoEvent) {
                DevSpy_InEPSActivity.this.check = 1;
                DevSpy_InEPSActivity CYMInEPSActivity = DevSpy_InEPSActivity.this;
                CYMInEPSActivity.youDesirePermissionCode(CYMInEPSActivity);
                DevSpy_InEPSActivity.this.enablesall();
            }
        }).build());
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DevSpy_InEPSActivity.this.onBackPressed();
            }
        });
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (i == 1 && Settings.System.canWrite(this)) {
                ...
                DevSpy_InUPSActivity.setAutoOrientationEnabled(getApplicationContext(), false);
                Settings.System.putInt(getContentResolver(), "screen_brightness", 20);
                ContentResolver.setMasterSyncAutomatically(false);
//                startActivity(new Intent(this, CY_M_BatterySaverActivity.class));
                finish();
            }
        }
    }
