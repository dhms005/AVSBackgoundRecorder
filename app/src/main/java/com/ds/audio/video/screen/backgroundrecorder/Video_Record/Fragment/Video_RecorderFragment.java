package com.ds.audio.video.screen.backgroundrecorder.Video_Record.Fragment;
...
public class Video_RecorderFragment extends Fragment {
    ...
    private Video_SharedPreHelper preHelper;
...
//            animationView.setVisibility(View.VISIBLE);
            ...
            this.mHandler = new Handler() {
                ...
                public void handleMessage(Message message) {
                    if (Video_RecorderFragment.this.elapsedTimer < 0) {
                        Video_RecorderFragment.this.tvTimer.setText(Video_TimeHelper.convertSecondsToHMmSs(0));
                    } else {
                        Video_RecorderFragment.this.tvTimer.setText(Video_TimeHelper.convertSecondsToHMmSs(Video_RecorderFragment.this.elapsedTimer));
                    }
                }
            };
            ...
            this.timer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    Video_RecorderFragment cCTVRecorderFragment = Video_RecorderFragment.this;
                    cCTVRecorderFragment.elapsedTimer = cCTVRecorderFragment.preHelper.getSecondsInTwoTime(Video_RecorderFragment.this.preHelper.getTimeRecord());
                    Video_RecorderFragment.this.mHandler.obtainMessage(1).sendToTarget();
                }
            }, 0, 1000);
    ...
    public void startRecording() {
        ...
        if (this.hasPermissions) {
            if (this.isDrawOverlyAllowed) {
                startActivityForResult(((MediaProjectionManager) getActivity().getSystemService(Context.MEDIA_PROJECTION_SERVICE)).createScreenCaptureIntent(), PERMISSION_RECORD_DISPLAY);
                return;
            }
...
//    private void doRecord() {
//        img_record.setImageResource(R.drawable.ic_record_stop);
//        Intent intent = new Intent(getActivity(), Video_RecorderService.class);
...
//                animationView.setVisibility(View.INVISIBLE);
        ...
        Toasty.success(getContext(), getString(R.string.record_success), 0).show();
    }
