...
public class CY_M_NPMActivity extends AppCompatActivity {
    DecoView arcView;
    int check = 0;
    TextView completion;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_npm);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_NPMActivity.this);
            }
        });
//        mAdFunction();
        ...
        build.addArcSeriesItemListener(new SeriesItem.SeriesItemListener() {
            ...
            public void onSeriesItemAnimationProgress(float f, float f2) {
                ...
                TextView textView = CY_M_NPMActivity.this.completion;
                textView.setText(intValue + "%");
                if (f2 >= 10.0f && f2 < 50.0f) {
                    CY_M_NPMActivity.this.ist.setTextColor(Color.parseColor("#136af6"));
                    CY_M_NPMActivity.this.istpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 50.0f && f2 < 75.0f) {
                    CY_M_NPMActivity.this.sec.setTextColor(Color.parseColor("#136af6"));
                    CY_M_NPMActivity.this.secpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 75.0f && f2 < 90.0f) {
                    CY_M_NPMActivity.this.thir.setTextColor(Color.parseColor("#136af6"));
                    CY_M_NPMActivity.this.thirpic.setImageResource(R.drawable.ic_brown_dot);
                } else if (f2 >= 90.0f && f2 <= 100.0f) {
                    CY_M_NPMActivity.this.fou.setTextColor(Color.parseColor("#136af6"));
                    CY_M_NPMActivity.this.foupic.setImageResource(R.drawable.ic_brown_dot);
                }
            }
        });
        ...
        this.arcView.addEvent(new DecoEvent.Builder(100.0f).setIndex(addSeries).setDelay(1000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventEnd(DecoEvent decoEvent) {
                CY_M_NPMActivity.this.check = 1;
                CY_M_NPMActivity nPMActivityCYM = CY_M_NPMActivity.this;
                nPMActivityCYM.youDesirePermissionCode(nPMActivityCYM);
                CY_M_NPMActivity.this.editor.putString("mode", "0");
                CY_M_NPMActivity.this.editor.commit();
            }
        }).build());
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_NPMActivity.this.onBackPressed();
            }
        });
    }
