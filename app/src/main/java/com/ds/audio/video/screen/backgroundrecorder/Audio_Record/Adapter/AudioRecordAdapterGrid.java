...
public class AudioRecordAdapterGrid extends RecyclerView.Adapter<AudioRecordAdapterGrid.VideoHolder> {
    private ItemClickCallBack itemClickCallBack;
    private Activity mContext;
    private LayoutInflater mLayoutInflater;
    private List<AudioRecordModel> mList;

    public AudioRecordAdapterGrid(Activity context, List<AudioRecordModel> list) {
    ...
    public VideoHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new VideoHolder(this.mLayoutInflater.inflate(R.layout.audio_item_grid, viewGroup, false));
    }
    ...
    public class VideoHolder extends RecyclerView.ViewHolder {
        ...
        public VideoHolder(View view) {
            ...
            this.rootLayout.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    AudioRecordAdapterGrid.this.itemClickCallBack.onImageClick(view, VideoHolder.this.getAdapterPosition());
                }
            });
