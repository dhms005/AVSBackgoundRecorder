...
public class CY_M_PermissionScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cy_mpermission_screen);
        ...
        tvAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (tvAccept.getText().toString().equalsIgnoreCase("ACCEPT")) {
                    if (Permission_check(CY_M_PermissionScreen.this)) {
                        Intent i = new Intent(CY_M_PermissionScreen.this, CY_M_FirstActivity.class);
                        startActivity(i);
                    }
