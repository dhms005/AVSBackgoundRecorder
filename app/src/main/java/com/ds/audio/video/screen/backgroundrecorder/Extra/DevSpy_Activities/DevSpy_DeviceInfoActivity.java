...
import com.ds.audio.video.screen.backgroundrecorder.Extra.DevSpy_Helper.DevSpy_FileHelper;
...
public class DevSpy_DeviceInfoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.devspy_activity_device_info);
        mNativeAdNew();
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DevSpy_DeviceInfoActivity.this.onBackPressed();
            }
        });
    }
    ...
    public void getDeviceInfo() {
        try {
            ...
            Log.d(DevSpy_FileHelper.ERROR, "Error getting Device INFO");
        }
    }
