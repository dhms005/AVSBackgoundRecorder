...
import com.ds.audio.video.screen.backgroundrecorder.Utils.CY_M_LocaleHelper;
...
public class CY_M_MyApplication extends Application implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private static CY_M_Custom_Full_Ad_Timer custom_full_ad_timer;
    private static CY_M_MyApplication mInstance;
    public static final boolean HIDE_INCOMPLETE_FEATURES = true;

    private static CY_M_Custom_AppLovin_Timer custom_appLovin_timer;


    public CY_M_MyApplication(Activity activity) {
        this.activity = activity;
    }

    public CY_M_MyApplication() {
        this.activity = null;
    }
    ...
    public void onCreate() {
        ...
        custom_full_ad_timer = new CY_M_Custom_Full_Ad_Timer(this);
        custom_appLovin_timer = new CY_M_Custom_AppLovin_Timer(this);
...
//    }
    ...
    protected void attachBaseContext(Context base) {
        super.attachBaseContext(CY_M_LocaleHelper.onAttach(base, "en"));
        MultiDex.install(this);
    }


    public CY_M_Custom_Full_Ad_Timer getmanagerFullAdTimer() {
        CY_M_Custom_Full_Ad_Timer customfulladtimer = custom_full_ad_timer;
    ...
    public CY_M_Custom_AppLovin_Timer getCustom_appLovin_timer() {
        CY_M_Custom_AppLovin_Timer customfulladtimer = custom_appLovin_timer;
        if (customfulladtimer == null) {
            return null;
        }
        return customfulladtimer;
    ...
    public static synchronized CY_M_MyApplication getInstance() {

        if (mInstance == null) {
            mInstance = new CY_M_MyApplication();
        }
        return mInstance;
    }
    ...
    public void showAdIfAvailable(
            ...
            @NonNull CY_M_MyApplication.OnShowAdCompleteListener onShowAdCompleteListener) {
    ...
    public class AppOpenAdManager {
        ...
        private void showAdIfAvailable(
            ...
            isShowingAd = true;
            if (CY_M_Master_SplashScreen.isSplashLoading) {

                if (!CY_M_SharedPref.RESUME_OPEN_CHECKER) {
