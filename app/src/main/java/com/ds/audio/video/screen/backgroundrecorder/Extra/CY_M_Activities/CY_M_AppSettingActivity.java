...
public class CY_M_AppSettingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_app_setting);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_AppSettingActivity.this);
            }
        });
        mNativeAdNew();
        ...
        findViewById(R.id.language).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_AppSettingActivity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_AppSettingActivity.this.startActivity(new Intent(CY_M_AppSettingActivity.this, CY_M_LanguageActivity.class));
                    }
                });
            }
        });
        ...
        findViewById(R.id.update).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=" + CY_M_AppSettingActivity.this.getPackageName()));

                try {
                    CY_M_AppSettingActivity.this.startActivity(intent);
                } catch (ActivityNotFoundException unused) {
                    Toast.makeText(CY_M_AppSettingActivity.this, "You don't have Google Play installed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        findViewById(R.id.privacy).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (!CY_M_Utility.isConnectivityAvailable(CY_M_AppSettingActivity.this)) {
                    Toast.makeText(CY_M_AppSettingActivity.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(CY_M_AppSettingActivity.this, CY_M_PrivacyPolicyActivity.class);
                    startActivity(in);
                }
            }
        });
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_AppSettingActivity.this.onBackPressed();
            }
        });
