...
public class CY_M_Camere_Sensore_Detail_Activity extends AppCompatActivity {
    ImageView back;
    TextView textdetail;
    TextView title;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.cy_m_camere_sensore_detail);
        ...
        this.back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Camere_Sensore_Detail_Activity.this.onBackPressed();
            }
        });
        this.title = (TextView) findViewById(R.id.title);
        this.title.setText(CY_M_Camere_Camere_Test_Sensore_Activity.title);
        this.textdetail = (TextView) findViewById(R.id.textdetail);
        this.textdetail.setText(CY_M_Camere_Camere_Test_Sensore_Activity.textdetails);
    }
