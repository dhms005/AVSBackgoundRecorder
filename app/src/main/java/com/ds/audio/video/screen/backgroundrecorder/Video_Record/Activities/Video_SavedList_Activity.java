...
public class Video_SavedList_Activity extends AppCompatActivity {
    RecyclerView rvVideos;
    RecyclerView rvVideos_grid;
    Toolbar toolbar;
    private VideoRecordAdapterList adapter;
    private VideoRecordAdapterGrid adapterGrid;
    private List<VideoRecordModel> listVideo;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.video_saved_list_activity);
...
//                Toast.makeText(Video_SavedList_Activity.this, "Click", Toast.LENGTH_SHORT).show();
    ...
    private void setupRecylerView() {
        ...
        this.adapter = new VideoRecordAdapterList(this, this.listVideo);
        this.adapterGrid = new VideoRecordAdapterGrid(this, this.listVideo);
        ...
        this.adapter.setItemClickCallBack(new VideoRecordAdapterList.ItemClickCallBack() {
            @Override
            public void onImageClick(View view, final int i) {


                DevSpy_Admob_Full_AD_New.getInstance().showInter(Video_SavedList_Activity.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        Intent intent2 = new Intent(Video_SavedList_Activity.this, Video_SaveVideoActivity.class);
                        intent2.putExtra("videourl", ((VideoRecordModel) Video_SavedList_Activity.this.listVideo.get(i)).getFilePath());
                        Video_SavedList_Activity.this.startActivity(intent2);
                    }
                });
            }
            ...
            public void onChkBoxClick(View view, int i, boolean z) {
                ((VideoRecordModel) Video_SavedList_Activity.this.listVideo.get(i)).setSelect(z);
            }
        });
        ...
        new LoadVideo().execute(Video_FileHelper.videoPath(Video_SavedList_Activity.this));
    }
        ...
        if (itemId != R.id.action_delete) {
            switch (itemId) {
                ...
                case R.id.action_select_all:
                    for (VideoRecordModel cCTVVideoRecord : this.listVideo) {
                ...
                case R.id.action_share:
                    Video_FileHelper.shareVideo(this, this.listVideo.get(selected_item).getFilePath());
                    break;
    ...
    public boolean deleteFile(String str) {
        ...
        if (file.delete()) {
//            removeAt(i);
            Toast.makeText(Video_SavedList_Activity.this, "Delete Success", Toast.LENGTH_SHORT).show();
            Video_SavedList_Activity.check_deleted = true;

            return true;
        }
        Toast.makeText(Video_SavedList_Activity.this, "Delete Failed", Toast.LENGTH_SHORT).show();
    ...
    public class LoadVideo extends AsyncTask<String, Void, Void> {
        ...
        public void onPreExecute() {
            this.dialog = new ProgressDialog(Video_SavedList_Activity.this);
            this.dialog.setMessage(Video_SavedList_Activity.this.getString(R.string.loading));
...
//            LoadVideo loadVideo = this;
            ...
            if (file.isDirectory()) {
                ...
                while (true) {
                    ...
                    if (fileArr[i].getName().contains(".mp4")) {
...
//                    photos.add(photosTemp.get(i2));
                    ...
                    listVideo.add(new VideoRecordModel(photosTemp.get(i2),bitmap, "", filename, ""));
                }
            }
            return null;
        }
        ...
        public void onPostExecute(Void r1) {
            ...
            if (listVideo.size() > 0) {
                ...
                rvVideos.setVisibility(View.VISIBLE);
                Video_SavedList_Activity.this.adapter.notifyDataSetChanged();
                Video_SavedList_Activity.this.adapterGrid.notifyDataSetChanged();
            } else {
    ...
    public void onResume() {
        ...
        if (check_deleted) {
            Intent intent = new Intent(Video_SavedList_Activity.this, Video_SavedList_Activity.class);
