...
public class DevSpy_Admob_Full_AD_New implements androidx.lifecycle.LifecycleObserver {

    public InterstitialAd interstitialOne;
    public InterstitialAd interstitialTwo;
    MyCallback myCallback;
    private static DevSpy_Admob_Full_AD_New mInstance;
    ...
    public static List<DevSpy_CustomAdModel> myAppMarketingList = new ArrayList();
    ...
    public static DevSpy_Admob_Full_AD_New getInstance() {
        if (mInstance == null) {
            mInstance = new DevSpy_Admob_Full_AD_New();
        }
        return mInstance;
    }
        ...
        if (!SharePrefUtils.getBoolean(Constant_ad.IS_PURCHASE, false)) {
            ...
            if (total_count <= click && !Constant_ad.IsAdShowing) {
                if (SharePrefUtils.getInt(Constant_ad.MINUTE, 0) != 0) {
                    if (DevSpy_Utility.isTimerAdShow) {
                        DevSpy_Utility.isTimerAdShow = false;
                        click = 1;
...
//                        handler.postDelayed(this, 2000);
    ...
    public DevSpy_CustomAdModel getMyCustomAd(String str) {
        ...
        DevSpy_CustomAdModel customAdModel = null;
        if (arrayList.size() != 0) {
            for (int i4 = 0; i4 <= arrayList.size(); i4++) {
                customAdModel = (DevSpy_CustomAdModel) arrayList.get(i1);
            }
        }
    ...
    public List<DevSpy_CustomAdModel> get_CustomAdData() {
        ...
        try {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                DevSpy_CustomAdModel customAdModel = new DevSpy_CustomAdModel();
