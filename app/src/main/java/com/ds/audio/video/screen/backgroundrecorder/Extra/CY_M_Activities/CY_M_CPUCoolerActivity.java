...
import com.ds.audio.video.screen.backgroundrecorder.Extra.CY_M_Adapters.CY_M_RecyclerAdapter;
...
public class CY_M_CPUCoolerActivity extends AppCompatActivity {
    public static List<CY_M_Apps> apps;
    List<CY_M_Apps> CYMApps2;
    BroadcastReceiver batteryReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            CY_M_CPUCoolerActivity.this.makeStabilityScanning(intent);
        }
    };
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_cpu_cooler);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_CPUCoolerActivity.this);
            }
        });
//        mAdFunction();
        ...
        try {
            ...
            this.coolbutton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    Toast.makeText(CY_M_CPUCoolerActivity.this, "Temperature of CPU is Already Normal", 0).show();
                }
            });
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_CPUCoolerActivity.this.onBackPressed();
            }
        });
    }
    ...
    public void getAllICONS() {
            ...
            while (true) {
                ...
                if (!str.equals("fast.cleaner.battery.saver")) {
                    try {
                        ...
                        CY_M_Apps CYMApps3 = new CY_M_Apps();
        ...
        if (apps.size() > 1) {
            CY_M_RecyclerAdapter CYMRecyclerAdapter = new CY_M_RecyclerAdapter(apps);
    ...
    public void makeStabilityScanning(Intent intent) {
        ...
        if (((double) this.temp) >= 30.0d) {
            ...
            this.coolbutton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    SharedPreferences.Editor edit = CY_M_CPUCoolerActivity.this.getSharedPreferences("APPS_CONFIGS", 0).edit();
                    edit.putLong("COOLER_LAST_UPDATE", System.currentTimeMillis());
                    edit.commit();

                    CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_CPUCoolerActivity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                        @Override
                        public void callbackCall() {
                            CY_M_CPUCoolerActivity.this.startActivity(new Intent(CY_M_CPUCoolerActivity.this, CY_M_ScannerCPUActivity.class));
                        }
                    });
                    new Handler().postDelayed(new Runnable() {
                        public void run() {
                            CY_M_CPUCoolerActivity.this.nooverheating.setText("No App Overheating");
                            CY_M_CPUCoolerActivity.this.nooverheating.setTextColor(Color.parseColor("#136af6"));
                            CY_M_CPUCoolerActivity.this.ivtemping.setImageResource(R.drawable.ic_after_cooling_icon);
                            CY_M_CPUCoolerActivity.this.tempimg.setImageResource(R.drawable.ic_cooling_complete);
                            CY_M_CPUCoolerActivity.this.batterytemp.setText("25.3°C");
                            CY_M_CPUCoolerActivity.this.recyclerView.setAdapter((RecyclerView.Adapter) null);
                        }
                    }, 2000);
                    CY_M_CPUCoolerActivity.this.coolbutton.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View view) {
                            Toast.makeText(CY_M_CPUCoolerActivity.this, "Temperature of CPU is Already Normal", 0).show();
                        }
                    });
            ...
            this.mAdapter = new CY_M_RecyclerAdapter(apps);
