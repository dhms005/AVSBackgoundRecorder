...
public class CY_M_RecomendedAppsDailogAdapter_New extends RecyclerView.Adapter<CY_M_RecomendedAppsDailogAdapter_New.MyViewHolder> {

    public ArrayList<CY_M_RecommandDatabaseModel> recomendedAppArrayList;
    private Context mContext;
    int type = 1;
    String iconType;

    public CY_M_RecomendedAppsDailogAdapter_New(Context context, ArrayList<CY_M_RecommandDatabaseModel> recomendedAppArrayList, int type, String iconType) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = null;
        if (type == 8) {
            view = LayoutInflater.from(mContext).inflate(R.layout.cy_m_recomended_apps_item_8, viewGroup, false);
        } else if (type == 9) {
            view = LayoutInflater.from(mContext).inflate(R.layout.cy_m_recomended_apps_item_9, viewGroup, false);
        }
