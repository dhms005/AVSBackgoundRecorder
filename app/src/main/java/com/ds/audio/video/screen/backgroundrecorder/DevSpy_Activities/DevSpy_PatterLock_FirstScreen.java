...
public class DevSpy_PatterLock_FirstScreen extends AppCompatActivity {
            ...
            public boolean onComplete(ArrayList<Integer> ids) {
                ...
                if (_from.equals("splash")) {
                    if (getPatternString(ids).equals(SharePrefUtils.getString(Constant_ad.PATTERN_NUMBER, ""))) {
                        Intent intent = new Intent(DevSpy_PatterLock_FirstScreen.this, DevSpy_FirstActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(DevSpy_PatterLock_FirstScreen.this, "Wrong Pattern", Toast.LENGTH_SHORT).show();
                    }
                } else if (_from.equals("change_pattern")) {
                    if (getPatternString(ids).equals(SharePrefUtils.getString(Constant_ad.PATTERN_NUMBER, ""))) {
                        SharePrefUtils.putString(Constant_ad.PATTERN_NUMBER, "");
                        SharePrefUtils.putBoolean(Constant_ad.PATTERN_CONFIRM, false);
                        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(DevSpy_PatterLock_FirstScreen.this);
                        SharedPreferences.Editor editor = defaultSharedPreferences.edit();
                        editor.putBoolean("prefAppLock", false);
                        editor.commit();
                        Intent intent = new Intent(DevSpy_PatterLock_FirstScreen.this, DevSpy_PatterLock_Activity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(DevSpy_PatterLock_FirstScreen.this, "Wrong Pattern", Toast.LENGTH_SHORT).show();
                    ...
                    if (getPatternString(ids).equals(SharePrefUtils.getString(Constant_ad.PATTERN_NUMBER, ""))) {
                        ...
                        editor.putBoolean("prefAppLock", false);
                        editor.commit();
                        Intent intent = new Intent(DevSpy_PatterLock_FirstScreen.this, Video_Setting_Activity.class);
                        startActivity(intent);
                        finish();
                    } else {
                        Toast.makeText(DevSpy_PatterLock_FirstScreen.this, "Wrong Pattern", Toast.LENGTH_SHORT).show();
