...
public class CY_M_Second_StartScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cy_m_activity_second_start_screen);
        startCount = Integer.parseInt(SharePrefUtils.getString(Constant_ad.START_SCREEN_COUNT, ""));
        img_start = findViewById(R.id.img_start);

        if(CY_M_Utility.startStringText[CY_M_Utility.temPValue].contains("0")){
            img_start.setText(CY_M_Utility.startStringText[CY_M_Utility.temPValue].replace("0","'"));
        }else{
            img_start.setText(CY_M_Utility.startStringText[CY_M_Utility.temPValue]);
        }


        CY_M_Utility.temPValue++;
        load_qureka();
        mNativeAdNew();
    ...
    private void load_qureka() {
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               CY_M_Utility.OpenCustomQurekaBrowser(CY_M_Second_StartScreen.this);
            }
        });
    ...
    private void clickdata() {
        img_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Second_StartScreen.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        if (CY_M_Utility.temPValue < startCount) {
                            Intent intent = new Intent(CY_M_Second_StartScreen.this, CY_M_Second_StartScreen.class);
                            startActivity(intent);
                        } else {
                            Intent intent = new Intent(CY_M_Second_StartScreen.this, CY_M_ActivityHomeMenu.class);
                            startActivity(intent);
                        }
                    }
                });
        ...
        mTextPrivacyPolicy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!CY_M_Utility.isConnectivityAvailable(CY_M_Second_StartScreen.this)) {
                    Toast.makeText(CY_M_Second_StartScreen.this, "Please Connect Internet", Toast.LENGTH_SHORT).show();
                } else {
                    Intent in = new Intent(CY_M_Second_StartScreen.this, CY_M_PrivacyPolicyActivity.class);
                    startActivity(in);
                }
            }
        });
