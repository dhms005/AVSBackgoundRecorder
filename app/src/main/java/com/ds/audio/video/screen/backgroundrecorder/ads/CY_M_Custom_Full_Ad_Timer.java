 ...
 */
public class CY_M_Custom_Full_Ad_Timer implements androidx.lifecycle.LifecycleObserver {
    private static final String LOG_TAG = "AppOpenManager";

    private final CY_M_MyApplication ESMyApplication;
     ...
     * Constructor
     */
    public CY_M_Custom_Full_Ad_Timer(CY_M_MyApplication ESMyApplication) {
