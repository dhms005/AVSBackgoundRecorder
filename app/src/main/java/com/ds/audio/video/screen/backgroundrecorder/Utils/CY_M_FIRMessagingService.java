...
import com.ds.audio.video.screen.backgroundrecorder.CY_M_Activities.CY_M_FirstActivity;
...
public class CY_M_FIRMessagingService extends FirebaseMessagingService {
...
//                backIntent.putExtras(msg);
    ...
    private class DisplayToast implements Runnable {
        ...
        public void run() {
            Toast.makeText(CY_M_FIRMessagingService.this, mText, Toast.LENGTH_LONG)
                    .show();
        }
    }
