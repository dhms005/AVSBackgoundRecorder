...
import com.ds.audio.video.screen.backgroundrecorder.ads.CY_M_AdmobSplash_OpenAd;
import com.ds.audio.video.screen.backgroundrecorder.ads.CY_M_Admob_Full_AD_New;
import com.ds.audio.video.screen.backgroundrecorder.ads.CY_M_CommonFunction;
import com.ds.audio.video.screen.backgroundrecorder.ads.CY_M_MyApplication;
import com.ds.audio.video.screen.backgroundrecorder.ads.CY_M_Operators;
...
public class CY_M_Master_SplashScreen extends AppCompatActivity {
    ...
    private CY_M_AdmobSplash_OpenAd appOpenAdManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.cy_m_activity_splash_screen);

        mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        SharePrefUtils.putInt(Constant_ad.AD_STOP, 0);
        mediation = SharePrefUtils.getString(Constant_ad.MEDIATION, "0");
        if (isNetworkAvailable(CY_M_Master_SplashScreen.this)) {
            loadDataTxt(CY_M_Master_SplashScreen.this, false);
            GetPublicIP();
        } else {
            Internet_dialog();
        }
    ...
    public void Internet_dialog() {
        final Dialog dialog = new Dialog(CY_M_Master_SplashScreen.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setCancelable(false);
        dialog.setContentView(R.layout.cy_m_internet);
...
//                params.put(PushUser.IP_ADDRESS, SharePrefUtils.getString(Constant_ad.CITY_IP, "0.0.0.0"));
    ...
    public void setData(JSONObject response) {
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(CY_M_Master_SplashScreen.this);
...
//          JSONObject ads = response.getJSONObject("ads");
            ...
            CY_M_CommonFunction.checkBetweenTime(_startTime, _endTime);
            ...
            appOpenAdManager = new CY_M_AdmobSplash_OpenAd(CY_M_Master_SplashScreen.this);

            if (SharePrefUtils.getBoolean(Constant_ad.FIRST_TIME, true)) {
                CY_M_MyApplication.getInstance().callAd();
            }
...
//            DIGICustom_nativeAd_admob.showNativeSmallAds(this, findViewById(R.id.Admob_Native_Frame_two));
            ...
            if (SharePrefUtils.getInt(Constant_ad.POSITION1, 0) == 0 &&
                ...
                CY_M_Admob_Full_AD_New.getInstance().loadInterOne(CY_M_Master_SplashScreen.this);
                CY_M_Admob_Full_AD_New.getInstance().loadInterTwo(CY_M_Master_SplashScreen.this);
            } else if (SharePrefUtils.getInt(Constant_ad.POSITION1, 0) == 0 &&
                    SharePrefUtils.getInt(Constant_ad.POSITION2, 0) == 1) {
                CY_M_Admob_Full_AD_New.getInstance().loadInterOne(CY_M_Master_SplashScreen.this);
                CY_M_Admob_Full_AD_New.getInstance().loadInterTwo(CY_M_Master_SplashScreen.this);
                CY_M_Admob_Full_AD_New.getInstance().loadOpenAdOne(CY_M_Master_SplashScreen.this);
                CY_M_Admob_Full_AD_New.getInstance().loadOpenAdTwo(CY_M_Master_SplashScreen.this);
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    appOpenAdManager.showAdIfAvailable(CY_M_Master_SplashScreen.this,
                            new CY_M_MyApplication.OnShowAdCompleteListener() {
                                @Override
                                public void onShowAdComplete() {
                                    ...
                                    if (defaultSharedPreferences.getBoolean("prefAppLock", false) &&
                                        ...
                                        Intent i = new Intent(CY_M_Master_SplashScreen.this, CY_M_PatterLock_FirstScreen.class);
                                        i.putExtra("from", "splash");
                                        startActivity(i);
                                    } else {
                                        if (SharePrefUtils.getBoolean(Constant_ad.FEATURE_SCREEN, false)) {
                                            Intent i = new Intent(CY_M_Master_SplashScreen.this, CY_M_FirstActivity.class);
                                            startActivity(i);
                                        } else {
                                            Intent i = new Intent(CY_M_Master_SplashScreen.this, CY_M_FeatureActivity.class);
                                            startActivity(i);
                                        }
    ...
    public void GetPublicIP() {
        RequestQueue mRequestQueue = Volley.newRequestQueue(CY_M_Master_SplashScreen.this);
        StringRequest stringRequest = new StringRequest(Request.Method.GET, decryptionDataURL("[jjfi4//fhe^2f-(f2^1ec/;ied/?a>o*yIHrcsRIN(yXYhH"), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    loadDataService(CY_M_Master_SplashScreen.this);
                } catch (JSONException e) {
                    publicIP = "0.0.0.0";
    ...
    public void decryptionData(String data) {
        ...
        try {
            for (int i = 0; i < data.length(); i++) {
                ...
                int value = (int) ch;
                CY_M_Operators operators;
                switch (value) {
                    case 64:
                        operators = CY_M_Operators.A1;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 63:
                        operators = CY_M_Operators.A2;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 37:
                        operators = CY_M_Operators.A3;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 38:
                        operators = CY_M_Operators.A4;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 40:
                        operators = CY_M_Operators.A5;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 41:
                        operators = CY_M_Operators.A6;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 49:
                        operators = CY_M_Operators.A7;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 60:
                        operators = CY_M_Operators.A8;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 62:
                        operators = CY_M_Operators.A9;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 124:
                        operators = CY_M_Operators.A11;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 93:
                        operators = CY_M_Operators.A12;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 91:
                        operators = CY_M_Operators.A13;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 50:
                        operators = CY_M_Operators.A14;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 59:
                        operators = CY_M_Operators.A15;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 97:
                        operators = CY_M_Operators.A16;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 98:
                        operators = CY_M_Operators.A17;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 99:
                        operators = CY_M_Operators.A18;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 100:
                        operators = CY_M_Operators.A19;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 101:
                        operators = CY_M_Operators.A20;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 102:
                        operators = CY_M_Operators.A21;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 103:
                        operators = CY_M_Operators.A22;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 104:
                        operators = CY_M_Operators.A23;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 105:
                        operators = CY_M_Operators.A24;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 106:
                        operators = CY_M_Operators.A25;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 107:
                        operators = CY_M_Operators.A26;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 108:
                        operators = CY_M_Operators.A27;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 109:
                        operators = CY_M_Operators.A28;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 110:
                        operators = CY_M_Operators.A29;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 111:
                        operators = CY_M_Operators.A30;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 112:
                        operators = CY_M_Operators.A31;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 32:
                        operators = CY_M_Operators.A32;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 126:
                        operators = CY_M_Operators.A33;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 33:
                        operators = CY_M_Operators.A34;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 52:
                        operators = CY_M_Operators.A35;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 35:
                        operators = CY_M_Operators.A36;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 36:
                        operators = CY_M_Operators.A37;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 94:
                        operators = CY_M_Operators.A38;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 51:
                        operators = CY_M_Operators.A39;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 42:
                        operators = CY_M_Operators.A40;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 47:
                        operators = CY_M_Operators.A41;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 95:
                        operators = CY_M_Operators.A42;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 45:
                        operators = CY_M_Operators.A43;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;

                    case 113:
                        operators = CY_M_Operators.A44;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 114:
                        operators = CY_M_Operators.A45;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 115:
                        operators = CY_M_Operators.A46;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 116:
                        operators = CY_M_Operators.A47;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 117:
                        operators = CY_M_Operators.A48;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 118:
                        operators = CY_M_Operators.A49;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 119:
                        operators = CY_M_Operators.A50;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 120:
                        operators = CY_M_Operators.A51;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 121:
                        operators = CY_M_Operators.A52;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 122:
                        operators = CY_M_Operators.A53;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 65:
                        operators = CY_M_Operators.A54;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 66:
                        operators = CY_M_Operators.A55;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 67:
                        operators = CY_M_Operators.A56;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 68:
                        operators = CY_M_Operators.A57;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 69:
                        operators = CY_M_Operators.A58;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 70:
                        operators = CY_M_Operators.A59;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 71:
                        operators = CY_M_Operators.A60;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 72:
                        operators = CY_M_Operators.A61;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 73:
                        operators = CY_M_Operators.A62;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 74:
                        operators = CY_M_Operators.A63;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 75:
                        operators = CY_M_Operators.A64;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 76:
                        operators = CY_M_Operators.A65;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 77:
                        operators = CY_M_Operators.A66;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 78:
                        operators = CY_M_Operators.A67;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 79:
                        operators = CY_M_Operators.A68;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 80:
                        operators = CY_M_Operators.A69;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 81:
                        operators = CY_M_Operators.A70;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 82:
                        operators = CY_M_Operators.A71;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 83:
                        operators = CY_M_Operators.A72;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 84:
                        operators = CY_M_Operators.A73;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 85:
                        operators = CY_M_Operators.A74;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 86:
                        operators = CY_M_Operators.A75;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 87:
                        operators = CY_M_Operators.A76;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 88:
                        operators = CY_M_Operators.A77;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 89:
                        operators = CY_M_Operators.A78;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 90:
                        operators = CY_M_Operators.A79;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    case 92:
                        operators = CY_M_Operators.A80;
                        Newstr = Newstr + getOperatorValue(operators);
                        break;
                    default:
                        Newstr = Newstr + "0";
    ...
    public char getOperatorValue(CY_M_Operators operators) {

        switch (operators) {
            case A80:
                return (char) CY_M_Operators.A80.getOutput();
            case A79:
                return (char) CY_M_Operators.A79.getOutput();
            case A78:
                return (char) CY_M_Operators.A78.getOutput();
            case A77:
                return (char) CY_M_Operators.A77.getOutput();
            case A76:
                return (char) CY_M_Operators.A76.getOutput();
            case A75:
                return (char) CY_M_Operators.A75.getOutput();
            case A74:
                return (char) CY_M_Operators.A74.getOutput();
            case A73:
                return (char) CY_M_Operators.A73.getOutput();
            case A72:
                return (char) CY_M_Operators.A72.getOutput();
            case A71:
                return (char) CY_M_Operators.A71.getOutput();
            case A70:
                return (char) CY_M_Operators.A70.getOutput();
            case A69:
                return (char) CY_M_Operators.A69.getOutput();
            case A68:
                return (char) CY_M_Operators.A68.getOutput();
            case A67:
                return (char) CY_M_Operators.A67.getOutput();
            case A66:
                return (char) CY_M_Operators.A66.getOutput();
            case A65:
                return (char) CY_M_Operators.A65.getOutput();
            case A64:
                return (char) CY_M_Operators.A64.getOutput();
            case A63:
                return (char) CY_M_Operators.A63.getOutput();
            case A62:
                return (char) CY_M_Operators.A62.getOutput();
            case A61:
                return (char) CY_M_Operators.A61.getOutput();
            case A60:
                return (char) CY_M_Operators.A60.getOutput();
            case A59:
                return (char) CY_M_Operators.A59.getOutput();
            case A58:
                return (char) CY_M_Operators.A58.getOutput();
            case A57:
                return (char) CY_M_Operators.A57.getOutput();
            case A56:
                return (char) CY_M_Operators.A56.getOutput();
            case A55:
                return (char) CY_M_Operators.A55.getOutput();
            case A54:
                return (char) CY_M_Operators.A54.getOutput();
            case A53:
                return (char) CY_M_Operators.A53.getOutput();
            case A52:
                return (char) CY_M_Operators.A52.getOutput();
            case A51:
                return (char) CY_M_Operators.A51.getOutput();
            case A50:
                return (char) CY_M_Operators.A50.getOutput();
            case A49:
                return (char) CY_M_Operators.A49.getOutput();
            case A48:
                return (char) CY_M_Operators.A48.getOutput();
            case A47:
                return (char) CY_M_Operators.A47.getOutput();
            case A46:
                return (char) CY_M_Operators.A46.getOutput();
            case A45:
                return (char) CY_M_Operators.A45.getOutput();
            case A44:
                return (char) CY_M_Operators.A44.getOutput();
            case A43:
                return (char) CY_M_Operators.A43.getOutput();
            case A42:
                return (char) CY_M_Operators.A42.getOutput();
            case A41:
                return (char) CY_M_Operators.A41.getOutput();
            case A40:
                return (char) CY_M_Operators.A40.getOutput();
            case A39:
                return (char) CY_M_Operators.A39.getOutput();
            case A38:
                return (char) CY_M_Operators.A38.getOutput();
            case A37:
                return (char) CY_M_Operators.A37.getOutput();
            case A36:
                return (char) CY_M_Operators.A36.getOutput();
            case A35:
                return (char) CY_M_Operators.A35.getOutput();
            case A34:
                return (char) CY_M_Operators.A34.getOutput();
            case A33:
                return (char) CY_M_Operators.A33.getOutput();
            case A32:
                return (char) CY_M_Operators.A32.getOutput();
            case A31:
                return (char) CY_M_Operators.A31.getOutput();
            case A30:
                return (char) CY_M_Operators.A30.getOutput();
            case A29:
                return (char) CY_M_Operators.A29.getOutput();
            case A28:
                return (char) CY_M_Operators.A28.getOutput();
            case A27:
                return (char) CY_M_Operators.A27.getOutput();
            case A26:
                return (char) CY_M_Operators.A26.getOutput();
            case A25:
                return (char) CY_M_Operators.A25.getOutput();
            case A24:
                return (char) CY_M_Operators.A24.getOutput();
            case A23:
                return (char) CY_M_Operators.A23.getOutput();
            case A22:
                return (char) CY_M_Operators.A22.getOutput();
            case A21:
                return (char) CY_M_Operators.A21.getOutput();
            case A20:
                return (char) CY_M_Operators.A20.getOutput();
            case A19:
                return (char) CY_M_Operators.A19.getOutput();
            case A18:
                return (char) CY_M_Operators.A18.getOutput();
            case A17:
                return (char) CY_M_Operators.A17.getOutput();
            case A16:
                return (char) CY_M_Operators.A16.getOutput();
            case A15:
                return (char) CY_M_Operators.A15.getOutput();
            case A1:
                return (char) CY_M_Operators.A1.getOutput();
            case A2:
                return (char) CY_M_Operators.A2.getOutput();
            case A3:
                return (char) CY_M_Operators.A3.getOutput();
            case A4:
                return (char) CY_M_Operators.A4.getOutput();
            case A5:
                return (char) CY_M_Operators.A5.getOutput();
            case A6:
                return (char) CY_M_Operators.A6.getOutput();
            case A7:
                return (char) CY_M_Operators.A7.getOutput();
            case A8:
                return (char) CY_M_Operators.A8.getOutput();
            case A9:
                return (char) CY_M_Operators.A9.getOutput();
            case A11:
                return (char) CY_M_Operators.A11.getOutput();
            case A12:
                return (char) CY_M_Operators.A12.getOutput();
            case A13:
                return (char) CY_M_Operators.A13.getOutput();
            case A14:
                return (char) CY_M_Operators.A14.getOutput();
            default:
                return (char) CY_M_Operators.A1.getOutput();
        }
    }
