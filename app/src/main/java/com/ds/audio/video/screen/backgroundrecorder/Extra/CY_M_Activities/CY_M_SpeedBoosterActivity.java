...
import com.ds.audio.video.screen.backgroundrecorder.Extra.CY_M_Utils.CY_M_BoostAlarm;
...
public class CY_M_SpeedBoosterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_speed_booster);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_SpeedBoosterActivity.this);
            }
        });
//        mAdFunction();
        ...
        this.sharedpreferences = getSharedPreferences(CY_M_BoostAlarm.PREFERENCES_RES_BOOSTER, 0);
        try {
            ...
            optimizebutton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    if (CY_M_SpeedBoosterActivity.this.sharedpreferences.getString("booster", "1").equals("1")) {
                        CY_M_SpeedBoosterActivity.this.optimize();
                        CY_M_SpeedBoosterActivity CYMSpeedBoosterActivity = CY_M_SpeedBoosterActivity.this;
                        CYMSpeedBoosterActivity.editor = CYMSpeedBoosterActivity.sharedpreferences.edit();
                        CY_M_SpeedBoosterActivity.this.editor.putString("booster", "0");
                        CY_M_SpeedBoosterActivity.this.editor.commit();
                        SharedPreferences.Editor edit = CY_M_SpeedBoosterActivity.this.getSharedPreferences("APPS_CONFIGS", 0).edit();
                        edit.putLong("BOOSTER_LAST_UPDATE", System.currentTimeMillis());
                        edit.commit();
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            ((AlarmManager) CY_M_SpeedBoosterActivity.this.getSystemService(NotificationCompat.CATEGORY_ALARM)).set(0, System.currentTimeMillis() + 100000, PendingIntent.getBroadcast(CY_M_SpeedBoosterActivity.this, 0, new Intent(CY_M_SpeedBoosterActivity.this, CY_M_BoostAlarm.class), PendingIntent.FLAG_MUTABLE));

                        }else{
                            ((AlarmManager) CY_M_SpeedBoosterActivity.this.getSystemService(NotificationCompat.CATEGORY_ALARM)).set(0, System.currentTimeMillis() + 100000, PendingIntent.getBroadcast(CY_M_SpeedBoosterActivity.this, 0, new Intent(CY_M_SpeedBoosterActivity.this, CY_M_BoostAlarm.class), PendingIntent.FLAG_ONE_SHOT));

                        }

                        return;
                    }
                    Toast.makeText(CY_M_SpeedBoosterActivity.this, "Phone is Aleady Optimized", 0).show();
                }
            });
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_SpeedBoosterActivity.this.onBackPressed();
            }
        });
//        AdNative.getInstance().showNative100(this, (FrameLayout) findViewById(R.id.Admob_Banner_Frame));
    ...
    public void optimize() {
        ...
        this.arcView2.addEvent(new DecoEvent.Builder(DecoEvent.EventType.EVENT_SHOW, true).setDelay(500).setDuration(2000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventStart(DecoEvent decoEvent) {
                CY_M_SpeedBoosterActivity.this.bottom.setText("");
                CY_M_SpeedBoosterActivity.this.top.setText("");
                CY_M_SpeedBoosterActivity.this.centree.setText("Optimizing...");
            }
        }).build());
        this.arcView2.addEvent(new DecoEvent.Builder(25.0f).setIndex(addSeries).setDelay(2000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventEnd(DecoEvent decoEvent) {
                CY_M_SpeedBoosterActivity.this.bottom.setText("Found");
                CY_M_SpeedBoosterActivity.this.top.setText("Storage");
                Random random = new Random();
                TextView textView = CY_M_SpeedBoosterActivity.this.ramperct;
                textView.setText((random.nextInt(40) + 20) + "%");
                CY_M_SpeedBoosterActivity.this.centree.setText("00.00");
            }
        }).build());
        ...
        translateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                CY_M_SpeedBoosterActivity.this.scanlay.setVisibility(View.VISIBLE);
                CY_M_SpeedBoosterActivity.this.optimizelay.setVisibility(View.GONE);
                CY_M_SpeedBoosterActivity.this.scanning.setText("SCANNING...");
                CY_M_SpeedBoosterActivity.this.killall();
            }

            public void onAnimationEnd(Animation animation) {
                CY_M_SpeedBoosterActivity.this.scanlay.setVisibility(View.GONE);
                CY_M_SpeedBoosterActivity.this.optimizelay.setVisibility(View.VISIBLE);
                Random random = new Random();
                CY_M_SpeedBoosterActivity.this.x = random.nextInt(100) + 30;
                TextView textView = CY_M_SpeedBoosterActivity.this.centree;
                textView.setText((CY_M_SpeedBoosterActivity.this.getUsedMemorySize() - ((long) CY_M_SpeedBoosterActivity.this.x)) + " MB");
                CY_M_SpeedBoosterActivity CYMSpeedBoosterActivity = CY_M_SpeedBoosterActivity.this;
                CYMSpeedBoosterActivity.editor = CYMSpeedBoosterActivity.sharedpreferences.edit();
                SharedPreferences.Editor editor = CY_M_SpeedBoosterActivity.this.editor;
                editor.putString("value", (CY_M_SpeedBoosterActivity.this.getUsedMemorySize() - ((long) CY_M_SpeedBoosterActivity.this.x)) + " MB");
                CY_M_SpeedBoosterActivity.this.editor.commit();
                Log.e("used mem", CY_M_SpeedBoosterActivity.this.getUsedMemorySize() + " MB");
                Log.e("used mem", CY_M_SpeedBoosterActivity.this.getTotalRAM());
                CY_M_SpeedBoosterActivity.this.totalram.setText(CY_M_SpeedBoosterActivity.this.getTotalRAM());
                TextView textView2 = CY_M_SpeedBoosterActivity.this.usedram;
                textView2.setText((CY_M_SpeedBoosterActivity.this.getUsedMemorySize() - ((long) CY_M_SpeedBoosterActivity.this.x)) + " MB/ ");
                CY_M_SpeedBoosterActivity.this.appsfreed.setText(CY_M_SpeedBoosterActivity.this.getTotalRAM());
                TextView textView3 = CY_M_SpeedBoosterActivity.this.appused;
                textView3.setText(Math.abs((CY_M_SpeedBoosterActivity.this.getUsedMemorySize() - ((long) CY_M_SpeedBoosterActivity.this.x)) - 30) + " MB/ ");
                TextView textView4 = CY_M_SpeedBoosterActivity.this.processes;
                textView4.setText((CY_M_SpeedBoosterActivity.this.y - (new Random().nextInt(10) + 5)) + "");
            }
        });
    }
    ...
    public void start() {
        ...
        TimerTask r1 = new TimerTask() {
            public void run() {
                try {
                    CY_M_SpeedBoosterActivity.this.runOnUiThread(new Runnable() {
                        public void run() {
                            CY_M_SpeedBoosterActivity.this.counter++;
                            CY_M_SpeedBoosterActivity.this.centree.setText(CY_M_SpeedBoosterActivity.this.counter + "MB");
                        }
                    });
                } catch (Exception unused) {
                }
        ...
        this.arcView.addEvent(new DecoEvent.Builder((float) (new Random().nextInt(60) + 30)).setIndex(addSeries).setDelay(2000).setListener(new DecoEvent.ExecuteEventListener() {
            ...
            public void onEventEnd(DecoEvent decoEvent) {
                timer3.cancel();
                CY_M_SpeedBoosterActivity.this.timer.cancel();
                timer3.purge();
                TextView textView = CY_M_SpeedBoosterActivity.this.centree;
                textView.setText(CY_M_SpeedBoosterActivity.this.getUsedMemorySize() + " MB");
                if (CY_M_SpeedBoosterActivity.this.sharedpreferences.getString("booster", "1").equals("0")) {
                    CY_M_SpeedBoosterActivity.this.centree.setText(CY_M_SpeedBoosterActivity.this.sharedpreferences.getString("value", "50MB"));
                }
                new Timer();
                final Timer timer = new Timer();
                try {
                    CY_M_SpeedBoosterActivity.this.timer2 = new TimerTask() {
                        public void run() {
                            try {
                                CY_M_SpeedBoosterActivity.this.runOnUiThread(new Runnable() {
                                    public void run() {
                                        ...
                                        timer.cancel();
                                        CY_M_SpeedBoosterActivity.this.timer2.cancel();
                                        timer.purge();
                                    }
                                });
                            } catch (Exception unused) {
                ...
                timer.schedule(CY_M_SpeedBoosterActivity.this.timer2, 100, 100);
            }
        }).build());
    ...
    public void showint() {
        new FancyAlertDialog.Builder(this).setTitle(getResources().getString(R.string.speed_booster)).setBackgroundColor(Color.parseColor("#0c7944")).setMessage(getResources().getString(R.string.speedtxt)).setPositiveBtnBackground(Color.parseColor("#FF4081")).setPositiveBtnText("Ok").setNegativeBtnBackground(Color.parseColor("#FFA9A7A8")).setNegativeBtnText("Cancel").setAnimation(com.shashank.sony.fancydialoglib.Animation.POP).isCancellable(false).setIcon(R.drawable.booster, Icon.Visible).OnPositiveClicked(new FancyAlertDialogListener() {
            public void OnClick() {
                CY_M_SpeedBoosterActivity.this.getSharedPreferences("config", 0).edit().putBoolean("speedint", true).apply();
            }
