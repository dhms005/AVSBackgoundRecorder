...
public class CY_M_LanguageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_language);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_LanguageActivity.this);
            }
        });
        mNativeAdNew();
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_LanguageActivity.this.onBackPressed();
            }
        });
    ...
    public void openDialog(View view) {
        ...
        dialog.setContentView(R.layout.cy_m_dialog_language);
