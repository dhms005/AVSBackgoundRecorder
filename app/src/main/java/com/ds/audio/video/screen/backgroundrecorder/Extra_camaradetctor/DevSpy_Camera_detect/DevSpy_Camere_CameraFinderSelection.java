...
public class DevSpy_Camere_CameraFinderSelection extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.devspy_camere_activity_camera_finder_selection);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DevSpy_Utility.OpenCustomQurekaBrowser(DevSpy_Camere_CameraFinderSelection.this);
            }
        });
        ...
        this.btnboth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_Camere_CameraFinderSelection.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        DevSpy_Camere_CameraFinderSelection.this.startActivity(new Intent(DevSpy_Camere_CameraFinderSelection.this, DevSpy_Camere_CameraDetecter.class));
                    }
                });
            }
        });
        this.btnspeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_Camere_CameraFinderSelection.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        DevSpy_Camere_CameraFinderSelection.this.startActivity(new Intent(DevSpy_Camere_CameraFinderSelection.this, DevSpy_Camere_meterDetector.class));
                    }
                });
            }
        });
        this.btngraph.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_Camere_CameraFinderSelection.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        DevSpy_Camere_CameraFinderSelection.this.startActivity(new Intent(DevSpy_Camere_CameraFinderSelection.this, DevSpy_Camere_CameraDetectorByGraph.class));
                    }
                });
            }
        });
