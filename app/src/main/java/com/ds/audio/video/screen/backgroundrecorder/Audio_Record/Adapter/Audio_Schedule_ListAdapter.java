...
public class Audio_Schedule_ListAdapter extends RecyclerView.Adapter<Audio_Schedule_ListAdapter.ViewHolder> {
    ArrayList<UserModel> users;

    // RecyclerView recyclerView;
    public Audio_Schedule_ListAdapter(ArrayList<UserModel> users) {
        this.users = users;
    }
