...
public class ScreenRecorder_SavedList_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.screenrecorder_saved_list_activity);
...
//                Toast.makeText(ScreenRecorder_SavedList_Activity.this, "Click", Toast.LENGTH_SHORT).show();
    ...
    private void setupRecylerView() {
        ...
        this.adapter.setItemClickCallBack(new VideoRecordAdapterList.ItemClickCallBack() {
            ...
            public void onImageClick(View view, final int i) {
                ...
                DevSpy_Admob_Full_AD_New.getInstance().showInter(ScreenRecorder_SavedList_Activity.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    ...
                    public void callbackCall() {
                        ...
                        intent2.putExtra("videourl", ((VideoRecordModel) ScreenRecorder_SavedList_Activity.this.listVideo.get(i)).getFilePath());
                        ScreenRecorder_SavedList_Activity.this.startActivity(intent2);
                    }
                });
            }
            ...
            public void onChkBoxClick(View view, int i, boolean z) {
                ((VideoRecordModel) ScreenRecorder_SavedList_Activity.this.listVideo.get(i)).setSelect(z);
            }
        });
        ...
        new LoadVideo().execute(ScreenShot_Video_FileHelper.videoPath(ScreenRecorder_SavedList_Activity.this));
    }
    ...
    public boolean deleteFile(String str) {
        ...
        if (file.delete()) {
//            removeAt(i);
            Toast.makeText(ScreenRecorder_SavedList_Activity.this, "Delete Success", Toast.LENGTH_SHORT).show();
            ScreenRecorder_SavedList_Activity.check_deleted = true;

            return true;
        }
        Toast.makeText(ScreenRecorder_SavedList_Activity.this, "Delete Failed", Toast.LENGTH_SHORT).show();
    ...
    public class LoadVideo extends AsyncTask<String, Void, Void> {
        ...
        public void onPreExecute() {
            this.dialog = new ProgressDialog(ScreenRecorder_SavedList_Activity.this);
            this.dialog.setMessage(ScreenRecorder_SavedList_Activity.this.getString(R.string.loading));
...
//                    photos.add(photosTemp.get(i2));
        ...
        public void onPostExecute(Void r1) {
            ...
            if (listVideo.size() > 0) {
                ...
                rvVideos.setVisibility(View.VISIBLE);
                ScreenRecorder_SavedList_Activity.this.adapter.notifyDataSetChanged();
                ScreenRecorder_SavedList_Activity.this.adapterGrid.notifyDataSetChanged();
            } else {
    ...
    public void onResume() {
        ...
        if (check_deleted) {
            Intent intent = new Intent(ScreenRecorder_SavedList_Activity.this, ScreenRecorder_SavedList_Activity.class);
