...
public class Audio_SaveAudioActivity extends AppCompatActivity {
    CardView whatsapp;
    CardView facebook;
    CardView insta;
    CardView more;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.saved_audio_activity);
...
//        mNativeAdNew();
        ...
        this.whatsapp.setOnClickListener(view -> {
            shareImageAudioOnWhatsapp(context, videoUrl, true);
        });
        ...
        this.facebook.setOnClickListener(view -> {
            ...
            try {
                ...
                Toast.makeText(Audio_SaveAudioActivity.this, "Please Install Facebook", Toast.LENGTH_LONG).show();
            }
        });
        ...
        this.insta.setOnClickListener(view -> {
            ...
            try {
                ...
                Toast.makeText(Audio_SaveAudioActivity.this, "Please Install Instagram", Toast.LENGTH_LONG).show();
            }
        });
...
//                message3.create().show();
    ...
    public boolean deleteFile(String str) {
        ...
        if (file.delete()) {
//            removeAt(i);
            Toast.makeText(Audio_SaveAudioActivity.this, "Delete Success", Toast.LENGTH_SHORT).show();
            Audio_SavedList_Activity.check_deleted = true;

            return true;
        }
        Toast.makeText(Audio_SaveAudioActivity.this, "Delete Failed", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    private void initVideo() {
        ...
        if (getIntent() != null) {
            ...
            try {
                ...
                MediaController controller = new MediaController(Audio_SaveAudioActivity.this);
    ...
    public static void shareImageAudioOnWhatsapp(Context context, String filePath, boolean isAudio) {
    ...
    public void deleteDialog() {
        downloadDialog = new Dialog(Audio_SaveAudioActivity.this);
