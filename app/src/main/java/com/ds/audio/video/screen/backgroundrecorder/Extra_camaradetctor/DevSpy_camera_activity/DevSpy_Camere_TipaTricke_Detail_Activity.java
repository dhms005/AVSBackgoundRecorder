...
public class DevSpy_Camere_TipaTricke_Detail_Activity extends AppCompatActivity {
    ImageView back;
    TextView detail;
    TextView title;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.devspy_camere_tipsandtrick_detail_activity);
        ...
        this.title.setText(DevSpy_Camere_TipsAnd_Trick_Activity.title);
        ...
        this.detail.setText(DevSpy_Camere_TipsAnd_Trick_Activity.F);
        this.titlefooter = (TextView) findViewById(R.id.titlefooter);
        this.titlefooter.setText(DevSpy_Camere_TipsAnd_Trick_Activity.footertitle);
    }
