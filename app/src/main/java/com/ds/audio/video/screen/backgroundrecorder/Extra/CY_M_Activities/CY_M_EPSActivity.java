...
import com.ds.audio.video.screen.backgroundrecorder.Extra.CY_M_Adapters.CY_M_PowerModeAdapter;
...
public class CY_M_EPSActivity extends AppCompatActivity {
    ImageView applied;
    TextView extendedtime;
    TextView extendedtimedetail;
    int hour;
    List<CY_M_ItemPower> items;
    CY_M_PowerModeAdapter mAdapter;
    int min;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_eps);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_EPSActivity.this);
            }
        });
//        mNativeAdNew();
        ...
        this.applied.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_EPSActivity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_EPSActivity.this.startActivity(new Intent(CY_M_EPSActivity.this, CY_M_InEPSActivity.class));
                        CY_M_EPSActivity.this.finish();
                    }
                });
            }
        });
        ...
        this.mAdapter = new CY_M_PowerModeAdapter(this.items);
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Limit Brightness Upto 90%", 0);
            }
        }, 1000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Decrease Device Performance", 1);
            }
        }, 2000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Close All Battery Consuming Apps", 2);
            }
        }, 3000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Use Black and White Scheme To Avoid Battery Draning", 3);
            }
        }, 4000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Block Acess to Memory and Battery Draning Apps", 4);
            }
        }, 5000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_EPSActivity.this.add("Closes System Services like Bluetooth,Screen Rotation,Sync etc.", 5);
            }
        }, 6000);
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_EPSActivity.this.onBackPressed();
            }
        });
    }
    ...
    public void add(String str, int i) {
        CY_M_ItemPower CYMItemPower = new CY_M_ItemPower();
