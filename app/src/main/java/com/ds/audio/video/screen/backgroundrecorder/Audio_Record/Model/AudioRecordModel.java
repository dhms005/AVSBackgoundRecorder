package com.ds.audio.video.screen.backgroundrecorder.Audio_Record.Model;
...
public class AudioRecordModel {
    ...
    public AudioRecordModel(String str, Bitmap bitmap, String str2, String str3, String str4) {
        this.filePath = str;
