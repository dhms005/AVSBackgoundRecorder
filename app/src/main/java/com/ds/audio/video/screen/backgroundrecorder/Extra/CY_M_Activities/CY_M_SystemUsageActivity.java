...
public class CY_M_SystemUsageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_system_usage);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_SystemUsageActivity.this);
            }
        });
        mNativeAdNew();
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_SystemUsageActivity.this.onBackPressed();
            }
        });
    }
