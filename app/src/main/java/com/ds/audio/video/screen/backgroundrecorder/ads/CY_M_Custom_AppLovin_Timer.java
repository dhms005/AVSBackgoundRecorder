 ...
 */
public class CY_M_Custom_AppLovin_Timer implements androidx.lifecycle.LifecycleObserver {
    private static final String LOG_TAG = "FSO_Custom_AppLovin_Timer";

    private final CY_M_MyApplication myApplication;
     ...
     * Constructor
     */
    public CY_M_Custom_AppLovin_Timer(CY_M_MyApplication myApplication) {
