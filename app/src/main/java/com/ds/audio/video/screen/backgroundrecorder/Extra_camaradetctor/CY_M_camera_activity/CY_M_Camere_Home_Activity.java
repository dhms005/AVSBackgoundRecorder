...
import com.ds.audio.video.screen.backgroundrecorder.Extra_camaradetctor.CY_M_Camera_detect.CY_M_Camere_CameraFinderSelection;
import com.ds.audio.video.screen.backgroundrecorder.Extra_camaradetctor.CY_M_Camera_detect.CY_M_Camere_CameraScene;
import com.github.mylibrary.Notification.Ads.Constant_ad;
import com.github.mylibrary.Notification.Ads.Custom_Banner_Ad;
import com.github.mylibrary.Notification.Ads.SharePrefUtils;


public class CY_M_Camere_Home_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.cy_m_camere_home_activity);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_Camere_Home_Activity.this);
            }
        });
        ...
        this.spydeivicedetect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Camere_Home_Activity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_Camere_Home_Activity.this.startActivity(new Intent(CY_M_Camere_Home_Activity.this, CY_M_Camere_CameraFinderSelection.class));
                    }
                });
        ...
        this.infraedcamrea.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Camere_Home_Activity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_Camere_Home_Activity.this.startActivity(new Intent(CY_M_Camere_Home_Activity.this, CY_M_Camere_CameraScene.class));
                    }
                });
            }
        });
        ...
        this.tipsandtrick.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Camere_Home_Activity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_Camere_Home_Activity.this.startActivity(new Intent(CY_M_Camere_Home_Activity.this, CY_M_Camere_TipsAnd_Trick_Activity.class));
                    }
                });
            }
        });
        ...
        this.testsensor.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Camere_Home_Activity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_Camere_Home_Activity.this.startActivity(new Intent(CY_M_Camere_Home_Activity.this, CY_M_Camere_Camere_Test_Sensore_Activity.class));
                    }
                });
            }
        });
        ...
        this.howtowork.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_Camere_Home_Activity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_Camere_Home_Activity.this.startActivity(new Intent(CY_M_Camere_Home_Activity.this, CY_M_Camere_HowTo_Work_Activity.class));
                    }
                });
            }
        });
