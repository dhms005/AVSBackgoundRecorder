...
public class DevSpy_Camere_CameraScene extends AppCompatActivity implements SurfaceHolder.Callback {
    Camera l;
    SurfaceView m;
    SeekBar n;
    Camera.Parameters o;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.devspy_camere_activity_camera_scene);
    ...
    public void onBackPressed() {
        DevSpy_Admob_Full_AD_New.getInstance().showInterBack(this, new DevSpy_Admob_Full_AD_New.MyCallback() {
            ...
            public void callbackCall() {
                DevSpy_Camere_CameraScene.this.finish();
            }
        });
    }
