...
public class DevSpy_Camere_TipsAnd_Trick_Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.devspy_camere_tipsand_trick_activity);
        ...
        this.changignroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_Camere_TipsAnd_Trick_Activity.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        DevSpy_Camere_TipsAnd_Trick_Activity.title = "Changing room";
                        ...
                        DevSpy_Camere_TipsAnd_Trick_Activity.footertitle = "Possblity Spy Camera In Changing Room";
                        DevSpy_Camere_TipsAnd_Trick_Activity.this.startActivity(new Intent(DevSpy_Camere_TipsAnd_Trick_Activity.this, DevSpy_Camere_TipaTricke_Detail_Activity.class));
        ...
        this.Outside.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Admob_Full_AD_New.getInstance().showInter(DevSpy_Camere_TipsAnd_Trick_Activity.this, new DevSpy_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        DevSpy_Camere_TipsAnd_Trick_Activity.title = "Outside";
                        DevSpy_Camere_TipsAnd_Trick_Activity.F = "In outside world, you are not supposed to hide your identity in official places so just be cautious and behave accordingly.\n\nThe Security Areas the CCTV Camera fixed For Only Security Reason not For Spy Purpose So Don't Be Worry About It.\nThe Shopping Mall and Like The Army Camp and School Hospital, Library etc \n\nSome easy steps can save you from uneasy situations.";
                        DevSpy_Camere_TipsAnd_Trick_Activity.footertitle = "CCTV Camera Outside";
                        DevSpy_Camere_TipsAnd_Trick_Activity.this.startActivity(new Intent(DevSpy_Camere_TipsAnd_Trick_Activity.this, DevSpy_Camere_TipaTricke_Detail_Activity.class));
