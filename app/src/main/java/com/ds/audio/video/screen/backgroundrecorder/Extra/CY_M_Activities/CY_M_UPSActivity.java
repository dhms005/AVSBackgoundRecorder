...
public class CY_M_UPSActivity extends AppCompatActivity {
    ImageView applied;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.cy_m_activity_ups);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CY_M_Utility.OpenCustomQurekaBrowser(CY_M_UPSActivity.this);
            }
        });
//        mAdFunction();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_UPSActivity.this.editor.putString("mode", "1");
                CY_M_UPSActivity.this.editor.commit();
                CY_M_Admob_Full_AD_New.getInstance().showInter(CY_M_UPSActivity.this, new CY_M_Admob_Full_AD_New.MyCallback() {
                    @Override
                    public void callbackCall() {
                        CY_M_UPSActivity.this.startActivity(new Intent(CY_M_UPSActivity.this.getApplicationContext(), CY_M_InUPSActivity.class));
                        CY_M_UPSActivity.this.finish();
                    }
                });
            }
        });
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_UPSActivity.this.add("Limit Brightness Upto 80%", 0);
            }
        }, 1000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_UPSActivity.this.add("Decrease Device Performance", 1);
            }
        }, 2000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_UPSActivity.this.add("Close All Battery Consuming Apps", 2);
            }
        }, 3000);
        new Handler().postDelayed(new Runnable() {
            public void run() {
                CY_M_UPSActivity.this.add("Closes System Services like Bluetooth,Screen Rotation,Sync etc.", 3);
            }
        }, 4000);
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_UPSActivity.this.onBackPressed();
            }
        });
    }
