...
public class CY_M_Camere_meterDetector extends AppCompatActivity implements SensorEventListener {
    int[] beep = {R.raw.beep};
    private Gauge gauge;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.cy_m_camere_activity_meter_detector);
