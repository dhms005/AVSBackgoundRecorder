...
public class DevSpy_LanguageActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.devspy_activity_language);
        ...
        qureka_ad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DevSpy_Utility.OpenCustomQurekaBrowser(DevSpy_LanguageActivity.this);
            }
        });
        mNativeAdNew();
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DevSpy_LanguageActivity.this.onBackPressed();
            }
        });
    ...
    public void select(View view) {
        Toast.makeText(this, "Language Selected", 0).show();
    }
    ...
    public void openDialog(View view) {
        ...
        dialog.setContentView(R.layout.devspy_dialog_language);
