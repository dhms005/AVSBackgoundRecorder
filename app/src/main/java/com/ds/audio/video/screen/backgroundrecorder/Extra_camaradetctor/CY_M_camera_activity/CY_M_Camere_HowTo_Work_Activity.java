...
public class CY_M_Camere_HowTo_Work_Activity extends AppCompatActivity {
    ImageView back;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.cy_m_camere_howto_work_activity);
        mNativeAdNew();

        this.back = (ImageView) findViewById(R.id.back);
        this.back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                CY_M_Camere_HowTo_Work_Activity.this.onBackPressed();
            }
        });
    }
