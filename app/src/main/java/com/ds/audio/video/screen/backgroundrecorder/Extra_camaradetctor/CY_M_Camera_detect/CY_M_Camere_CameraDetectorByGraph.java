...
public class CY_M_Camere_CameraDetectorByGraph extends AppCompatActivity implements SensorEventListener, OnChartValueSelectedListener {
    int[] beep = {R.raw.beep};
    private Gauge gauge;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.cy_m_camere_activity_camera_detector_by_graph);
