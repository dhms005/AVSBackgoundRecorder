...
public class Custom_Admob_Full_Ad_Back {
    ...
    public void reload_admob_full_Ad(Context context) {
        ...
        InterstitialAd.load(context, SharePrefUtils.getString(Constant_ad.GOOGLE_FULL_AD, Custom_Ad_Key.KEY_ADMOB_FULL), adRequest, new InterstitialAdLoadCallback() {
            @Override
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                if (Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener != null) {
                    Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener.onAdLoaded();
                }
                full_admethod();
//                Log.e("Ad", "onAdLoaded");
            }
...
//                Log.e("Ad", loadAdError.getMessage());
                ...
                admob_mInterstitialAd_temp = false;
                if (Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener != null) {
                    Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener.onAdFailedToLoad();
                }
            }
...
//                Log.e("Ad", "The ad was dismissed.");
                ...
                if (Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener != null) {
                    Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener.onAdClosed();
                }
            }
...
//                Log.e("Ad", "The ad was shown.");
                if (Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener != null) {
                    Custom_Admob_Full_Ad_Back.this.mMyAdViewAdListener.onAdOpened();
                }
            }
        });
    }
