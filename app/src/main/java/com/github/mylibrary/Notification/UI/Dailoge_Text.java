...
public class Dailoge_Text extends Activity {
    ...
    String button1_color, button1_text_color,
            ...
            title_bgcolor, title_text_color, user_field;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        e_name.setTextColor(Color.parseColor("#000000"));

        if (bgcolor.equals(title_bgcolor)){
            e_name.getBackground().setColorFilter(Color.parseColor(title_text_color), PorterDuff.Mode.SRC_ATOP);
        }else {
            e_name.getBackground().setColorFilter(Color.parseColor(title_bgcolor), PorterDuff.Mode.SRC_ATOP);
        }
       ...
       /* LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
        ...
        tv_btn1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                final SharedPreferences prefs = Dailoge_Text.this.getSharedPreferences("GCM",
                        Context.MODE_PRIVATE);
                String api_key = prefs.getString(PushUser.API_KEY, "");

                Update_Data(api_key, user_field, e_name.getText().toString());
            }
        });
    ...
    private void Update_Data(final String token, final String user_field_name, final String user_field_value) {
        RequestQueue mRequestQueue = Volley.newRequestQueue(Dailoge_Text.this);
...
//                    Log.e("goterror",""+error);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(PushUser.APP_ANDROID_ID, DeviceUtils.getDeviceId(Dailoge_Text.this) + "");
